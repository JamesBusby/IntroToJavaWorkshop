...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	ScaryMaze() throws Exception {
		...
		maze = ImageIO.read(getClass().getResource("maze _1.jpg"));
	...
	private void scare() {
		...
		AudioClip sound = JApplet.newAudioClip(getClass().getResource("Man_Screaming.wav"));
	...
	@Override
	public void run() {
		JFrame frame = new JFrame("James's Scary Maze");
		frame.add(this);
